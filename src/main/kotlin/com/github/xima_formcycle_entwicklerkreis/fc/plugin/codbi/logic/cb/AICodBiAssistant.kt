      ...
      if (requested.isEmpty()) {
        ...
        val rethinkSystemPrompt =
            "You are a CodBi form element configurator. " +
                ...
                "AI CHAT WIDGET — For AI chat / KI-Chat elements: data-cb-func=\"ai.llama.chat\" goes ONLY on the chat display XTextArea — NOT on the container. Add cssclasses: AI_LLAMA_CHAT_Send to the send button, AI_LLAMA_CHAT_Stop to the stop button, AI_LLAMA_CHAT_Upload on upload, AI_LLAMA_CHAT_Thinking/Internet/Location/AlertOnFinish on checkboxes, AI_LLAMA_CHAT_MailForward on mail checkbox, AI_LLAMA_CHAT_MailAddress on email text field. On the MailAddress field also set hiddenif=\"9\", hiddenifcomp=\"<checkboxName>\" and hiddenifclear=\"false\" as DIRECT properties (not inside attributes). Keep all items in the items array.\n" +
