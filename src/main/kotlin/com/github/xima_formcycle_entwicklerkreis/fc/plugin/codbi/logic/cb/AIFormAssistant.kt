  ...
  private fun handleRun(params: IPluginServletActionParams): IPluginServletActionRetVal {
    ...
    val systemPrompt =
        "You are a FORMCYCLE form structure assistant. You receive a partial IPersistJson object " +
            ...
            "=== AI === AI_LLAMA_CHAT_Input, AI_LLAMA_CHAT_Send, AI_LLAMA_CHAT_Stop, AI_LLAMA_CHAT_Upload (upload field), AI_LLAMA_CHAT_Thinking (checkbox), AI_LLAMA_CHAT_Internet (checkbox), AI_LLAMA_CHAT_Location (checkbox), AI_LLAMA_CHAT_MailForward (checkbox), AI_LLAMA_CHAT_MailAddress (email text field), AI_LLAMA_CHAT_AlertOnFinish (checkbox), AI_LLAMA_STANDARD_QA_Question, AI_LLAMA_STANDARD_TXTQA_Question, AI_LLAMA_TXTQA_Source, AI_LLAMA_QA_Exclude, AI_OCR_Receiver\n" +
            ...
            "  {\"className\":\"XTextField\",\"properties\":{\"name\":\"tfMailAddress\",\"id\":\"xi-tf-mail-address\",\"label\":\"E-Mail-Adresse\",\"required\":\"0\",\"readonly\":\"0\",\"placeholder\":\"\",\"datatype\":\"email\",\"fullwidth\":\"0\",\"hiddenif\":\"9\",\"hiddenifcomp\":\"cbMailForward\",\"hiddenifclear\":\"false\",\"cssclasses\":[\"AI_LLAMA_CHAT_MailAddress\"]}}\n" +
