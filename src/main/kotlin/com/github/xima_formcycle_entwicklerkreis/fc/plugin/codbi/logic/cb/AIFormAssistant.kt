  ...
  private fun handleRun(params: IPluginServletActionParams): IPluginServletActionRetVal {
    ...
    val systemPrompt =
        "You are a FORMCYCLE form structure assistant. You receive a partial IPersistJson object " +
            ...
            "CRITICAL — AI.OCR with Mode=\"print\": do NOT set data-cb-Field on the upload. The receiver text field is identified by its CodBi_AI_OCR_Receiver CSS class, not by data-cb-Field. Example — XUpload has only data-cb-func and data-cb-mode (NO data-cb-Field):\n" +
            ...
            "{\"className\":\"XTextField\",\"properties\":{\"name\":\"tfExtractedText\",\"label\":\"Extracted Text\",\"cssclasses\":[\"CodBi_AI_OCR_Receiver\"]}}\n" +
