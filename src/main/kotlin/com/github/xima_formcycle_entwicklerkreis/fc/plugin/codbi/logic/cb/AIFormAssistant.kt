  ...
  private fun handleRun(params: IPluginServletActionParams): IPluginServletActionRetVal {
    ...
    val systemPrompt =
        "You are a FORMCYCLE form structure assistant. You receive a partial IPersistJson object " +
            ...
            "CRITICAL — _codbiApplicability.considered and _codbiApplicability.applied must contain ONLY CodBi functionality IDs (e.g. AI.OCR, HTML.Input.REGEX) or standard configuration names (e.g. Holistic.Matomo.Tracking). " +
            "Do NOT put CSS class names (like CodBi_AI_OCR_Receiver) in considered or applied — CSS classes go in the element's cssclasses array, not in _codbiApplicability. " +
