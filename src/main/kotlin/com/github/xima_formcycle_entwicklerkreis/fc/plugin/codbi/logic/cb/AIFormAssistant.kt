  ...
  private fun handleRun(params: IPluginServletActionParams): IPluginServletActionRetVal {
    ...
    val systemPrompt =
        "You are a FORMCYCLE form structure assistant. You receive a partial IPersistJson object " +
            ...
            "Do NOT set data-cb-func attributes in this pass — the server handles functionality application in a second pass. " +
            "However, you MUST include CSS classes in the form JSON's cssclasses arrays AND add standard configuration entries to the \"applied\" array. " +
            "Standard configuration activation: include {\"id\":\"AI\",\"targets\":[]} in \"applied\" when using AI.OCR, AI.LLAMA.CHAT or any AI functionality. " +
            ...
            "\"applied\":[{\"id\":\"Holistic.Matomo.Tracking\",\"targets\":[]}, {\"id\":\"AI\",\"targets\":[]}] (standard configuration names ONLY — add AI config when using AI.OCR/LLAMA, add Matomo config when using Matomo tracking)," +
            "\"skipped\":[]}. " +
