...
internal data class DetectedLanguage(
    ...
    val sendingMailLabel: String = "\u2709\uFE0F Sending email to: \"%s\"",
    ...
    val uiReadingLabel: String = "Reading page: \u201C%s\u201D…",
    val uiReadingLabelNoUrl: String = "Reading page content…",
    val uiSendingMailLabel: String = "Sending email to \u201C%s\u201D…",
    val uiSendingMailLabelNoRecipient: String = "Sending email…",
