...
- nodeParams: {"connection":"<database connection / datasource name>","sql":"<SQL text with [%fieldName%] placeholders, e.g. INSERT INTO Hulu (Narrative) VALUES ('<json>')>"} — ask for the connection only when it cannot be derived from the prompt.
