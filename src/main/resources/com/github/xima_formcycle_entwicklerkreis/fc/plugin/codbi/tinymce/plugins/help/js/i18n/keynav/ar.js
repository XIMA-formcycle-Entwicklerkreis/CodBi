tinymce.Resource.add(
  ...
  "<h1>بدء التنقل بواسطة لوحة المفاتيح</h1>\n" +
    ...
    "</ol>\n" +
    "\n" +
    "<p>إذا لم يكن قسم واجهة المستخدم موجودا، فسيتم تخطيه.</p>\n" +
    "\n" +
    ...
    "\n" +
    '<p>إذا كان التركيز الحالي على "الجزء العلوي" من قسم معين لواجهة المستخدم، فإن الضغط على مفتاح <strong>Esc</strong> يؤدي أيضا إلى الخروج\n' +
