!(function () {
  ...
  const U = (e) => i(e) && "a" === e.nodeName.toLowerCase(),
    ...
    $ = (e) => {
      var t, n;
      return null !==
        (n = null !== (t = e.getAttribute("data-mce-href")) && void 0 !== t ? t : e.getAttribute("href")) &&
        void 0 !== n
        ? n
        : "";
    },
          ...
          return "url" === r
            ? ((e) => {
                const t =
                  ...
                  w(
                    n.text.length <= 0,
                    m.from(null === (r = o.meta) || void 0 === r ? void 0 : r.text).getOr(o.value),
                  ));
                var o, r;
                const l = ((e) => {
                  var t;
                  return w(
                    n.title.length <= 0,
                    m.from(null === (t = e.meta) || void 0 === t ? void 0 : t.title).getOr(""),
                  );
                })(e.url);
