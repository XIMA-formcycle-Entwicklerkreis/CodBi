!(function () {
      ...
      S(e, (t, n) => {
        ((e, t) => {
          ...
          (e) => {
            return (
              (o = e),
              void (Lt((n = t)) && Lt(o) && ((n.listType = o.listType), (n.listAttributes = { ...o.listAttributes })))
            );
            var n, o;
          },
        );
      ...
      const n = be(
          ((e) => {
            ...
            return T(n, (e) => {
              return (
                (t = z(e)),
                se(t).exists((e) => He(e.dom) && ae(e).exists((e) => !Ue(e.dom)) && de(e).exists((e) => !Ue(e.dom)))
              );
              var t;
            }).fold(
              () => gt(e, t),
  ...
  const jt = De.DOM,
    ...
    zt = (e) => {
      ...
      return (
        n.setStart(e.startContainer, e.startOffset), e.endContainer && n.setEnd(e.endContainer, e.endOffset), it(n)
      );
    },
    Qt = (e) => {
      switch (e) {
            ...
            e.windowManager.open({
              ...
              onSubmit: (t) => {
                ((e) => {
                  switch (
                    ((e) =>
                      /^[0-9]+$/.test(e) ? 2 : /^[A-Z]+$/.test(e) ? 0 : /^[a-z]+$/.test(e) ? 1 : e.length > 0 ? 4 : 3)(
                      e,
                    )
                  ) {
                    case 2:
