...
export class Manager implements AfterViewInit {
      ...
      if (!existent) {
        currentNodelevel.push({
          ...
          data: {
            ...
            Parameter: [new CommonApiParameter("Neuer Parameter...", "Keine Beschreibung...")],
            Notes: "Neu Erstellt",
          },
  ...
  onRowEditSave(product: ApiParameter, index: number) {
    this.currentlySelectedFunctionalityData.Parameter[index] = product;
  }
  ...
  onClick_CodBi_LocalAPIDoc_RightPanel_AddParameter() {
    this.currentlySelectedFunctionalityData.Parameter.push(
      new CommonApiParameter("Neuer Parameter...", "Keine Beschreibung..."),
    );
  }
