      ...
      getJQuery()
        .ajax({
          ...
          headers: {
            ...
            "X-Param1": params[4] ? (params[4] as string).replace("=", "-") : "",
            "X-Param2": params[5] ? (params[5] as string).replace("=", "-") : "",
            "X-Param3": params[6] ? (params[6] as string).replace("=", "-") : "",
            "X-Param4": params[7] ? (params[7] as string).replace("=", "-") : "",
